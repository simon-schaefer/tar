...
dropping $PSNR$ by $42 \%$ by adding noise with $\sigma = 0.11$ ($X_{SLR} \in
...
perturbations, comp. \myfigref{fig:epsball_perturbation}. Also an increasing
$\epsilon$ improves the convergence rate during training, as shown in
\myfigref{fig:epsball_loss}. 
