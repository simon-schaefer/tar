...
#python3 /scratch_net/biwidl215/sischaef/tar/src/tar/main.py --template IM_AE_TAD_DIV2K --no_augment --verbose --data_range 1-100/1-10 --batch_size 5 --loss HR*10*MSE+LR*1*L1 --print_every