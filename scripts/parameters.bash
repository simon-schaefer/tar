...
export SR_PROJECT_ACCOUNT="sischaef@biwidl211"
...
export SR_PROJECT_PARAMS_PATH="$SR_PROJECT_PROJECT_HOME/parameters"
export SR_PROJECT_VIRTUAL_ENV_PATH="/scratch_net/biwidl211/sischaef/venv"
