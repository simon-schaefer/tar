...
def build_net():
    return CONV_ONLY_VERY_LARGE()

class CONV_ONLY_VERY_LARGE(nn.Module):

    def __init__(self):
        super(CONV_ONLY_VERY_LARGE, self).__init__()
        # Build encoding part.
        ...
        self._conv_en5 = nn.Conv2d(128, 128, 3, stride=1, padding=1)
        self._conv_en6 = nn.Conv2d(128, 64, 3, stride=1, padding=1)
        ...
        self._conv_de5 = nn.Conv2d(128, 128, 3, stride=1, padding=1)
        self._conv_de6 = nn.Conv2d(128, 64, 3, stride=1, padding=1)
        self._conv_de7 = nn.Conv2d(64, 64, 3, stride=1, padding=1)
